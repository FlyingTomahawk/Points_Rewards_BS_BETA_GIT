...
define('MODULES_ADMIN_MENUCUSTOMERS_POINTS', 'Customers Points');
define('MODULES_ADMIN_MENUCUSTOMERS_POINTS_PENDING', 'Pending Points');
define('MODULES_ADMIN_MENUCUSTOMERS_POINTS_REFERRAL', 'Referral Points');
