...
define('HEADING_TITLE', 'Offene Empfehlungs- Bewertungspunkte');
...
define('TABLE_HEADING_POINTS_TYPE', 'Punkte Typ');
...
define('TEXT_DEFAULT_REVIEWS', 'Bewertungspunkte');
define('TEXT_TYPE_REFERRAL', 'Empfehlung');
define('TEXT_TYPE_REVIEW', 'Bewertung');
...
define('TEXT_INFO_ORDER_ID', 'Bestellnummer:');
define('TEXT_INFO_ORDER_TOTAL', 'Gesamtsumme:');
define('TEXT_INFO_ORDER_STATUS', 'Bestellstatus:');
define('TEXT_INFO_PRODUCT_ID', 'Produkte ID:');
define('TEXT_INFO_REVIEW_ID', 'Bewertungs ID:');
define('TEXT_INFO_PRODUCT_NAME', 'Produktname:');
define('TEXT_INFO_REFERRED', 'Empfohlen durch:');
define('TEXT_INFO_PAYMENT_METHOD', 'Zahlungsart:');
define('TEXT_INFO_CURRENT_BALANCE', 'Aktueller Punktestand:');
