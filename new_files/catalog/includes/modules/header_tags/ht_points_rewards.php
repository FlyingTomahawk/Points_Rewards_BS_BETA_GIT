...
*/
  ...
  class ht_points_rewards {
    ...
    function install() {
      ...
      tep_db_query("insert into configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, last_modified, date_added) values ('Enable Products Model Restriction', 'MODULE_HEADER_TAGS_POINTS_REWARDS_POINTS_RESTRICTION_MODEL', '', 'Restriction Products by model.<br>Set product model Allowed or leave empty to disable it.', '6', '15', now(), now())");
