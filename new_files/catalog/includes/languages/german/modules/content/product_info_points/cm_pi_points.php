...
*/
  ...
  define('MODULE_CONTENT_PRODUCT_INFO_POINTS_HT_WARNING', 'Das benötigte <strong>Bonuspunkte Header Tags Modul</strong> ist nicht installiert.');
  define('MODULE_CONTENT_PRODUCT_INFO_POINTS_HT_INSTALL_NOW', '<u>Installieren Sie jetzt das Bonuspunkte Header Tags Modul</u>');
  define('MODULE_CONTENT_PRODUCT_INFO_POINTS_OT_WARNING', 'Das benötigte <strong>Bonuspunkte Order Total Modul</strong> ist nicht installiert.');
  define('MODULE_CONTENT_PRODUCT_INFO_POINTS_OT_INSTALL_NOW', '<u>Installieren Sie jetzt das Bonuspunkte Order Total Modul</u>');
