...
// used in orders.php
define('POINTS_HOOK_ORDERS_ENTRY_NOTIFY_POINTS', 'Offene Punkte für diese Bestellung:');
define('POINTS_HOOK_ORDERS_QUE_POINTS', 'Bestätigen');
define('POINTS_HOOK_ORDERS_QUE_DEL_POINTS', 'Löschen');
