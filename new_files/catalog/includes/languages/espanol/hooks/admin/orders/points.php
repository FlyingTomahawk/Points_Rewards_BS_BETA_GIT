...
// used in orders.php
define('POINTS_HOOK_ORDERS_ENTRY_NOTIFY_POINTS', 'Puntos de Compra Pendientes de este pedido:');
define('POINTS_HOOK_ORDERS_QUE_POINTS', 'Validar');
define('POINTS_HOOK_ORDERS_QUE_DEL_POINTS', 'Eliminar');
